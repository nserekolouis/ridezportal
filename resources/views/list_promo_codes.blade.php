...
<div class="col-md-6 col-sm-12">
    <div class="box box-danger">
        <form method="get" action="{{ URL::Route('/sortpromo') }}">
...
<div class="col-md-6 col-sm-12">
    <div class="box box-danger">
        <form method="get" action="{{ URL::Route('/searchpromo') }}">
            <div class="box-header">
        ...
        <tbody>
            ...
            <?php foreach ($promo_codes as $promo) { ?>
                <tr>
                    ...
                    <td><?php
                        if ($promo->is_event) {
                            $code_length = strlen($promo->coupon_code);
