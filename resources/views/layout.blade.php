...
<html>
    ...
    <head>
        ...
        <link rel="icon" type="image/ico" href="{{ asset('/web/ic_logo_ridez.png')}}">
    ...
    <body class="skin-blue" >
        ...
        <header class="header">
            <a  class="logo" href="{{ URL::Route('AdminMapview') }}" >
                ...
                <img src="{{ asset('/web/ic_logo_ridez.png')}}"  width="40" height="40"> <?php
                ...
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <!-- <li id="push_notifications" title="Push Notifications">
                            <a href="{{ URL::Route('AdminPushNotifications') }}"><i class="fa fa-gift"></i> <span>{{ trans('customize.push_notifications') }}</span></a>
                        </li> -->
        ...
        <!-- AdminLTE App -->
        <script src="<?php public_path(); ?>/admins/js/AdminLTE/app.js" type="text/javascript"></script>
        <!-- AdminLTE for demo purposes -->
        <script src="<?php public_path(); ?>/admins/js/AdminLTE/demo.js" type="text/javascript"></script>
