        ...
        <div class="box box-primary">
            ...
            <form method="post" action="{{ URL::Route('AdminKeywordsSave') }}"  enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Referral Payment Icon</label>
                    ...
                    <div class="form-group">
                        <label>Promotional Payment Icon</label>
                    ...
                    <div class="form-group">
                        <label>Total {{ trans('customize.Schedules').'s' }} Icon</label>
