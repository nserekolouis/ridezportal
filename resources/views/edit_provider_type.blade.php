...
<div class="box box-primary">
    ...
    <form method="post" id="basic" action="{{ URL::Route('AdminProviderTypeUpdate') }}"  enctype="multipart/form-data">
        ...
        <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" class="form-control" onkeypress="return Isamount(event, 1);" placeholder="Base Price" name="base_price" value="<?= $base_price ?>" onblur="notzero(1)" id="no_zero_1" required="">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" class="form-control" onkeypress="return Isamount(event, 2);" placeholder="Price Per Unit Distance" name="distance_price" value="<?= $price_per_unit_distance ?>" onblur="notzero(2)" id="no_zero_2" required="">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            ...
            <input type="text" class="form-control" onkeypress="return Isamount(event, 3);" placeholder="Price Per Unit Time" name="time_price" value="<?= $price_per_unit_time ?>" onblur="notzero(3)" id="no_zero_3" required="">
        </div>
        <div class="form-group col-md-6 col-sm-6">
            <label>Maximum Size</label> <span id="no_number_error1" style="display: none"> </span>
            <span id="no_zero_error4" style="display: none"> </span>
            <input type="text" class="form-control" onkeypress="return IsNumeric(event, 1);" placeholder="Maximum Size" name="max_size" value="<?= $max_size ?>"  onblur="notzero(4)" id="no_zero_4" required="">
        </div>
        <?php if (!$is_default == 1) { ?>
            <div class="form-group col-md-6 col-sm-6">
...
<?php if ($success == 3) { ?>
    <script type="text/javascript">
        alert('Sorry You can\'t set any price as ZERO "0"');
    </script>
<?php } ?>
<?php if ($success == 4) { ?>
    <script type="text/javascript">
