...
<div class="col-md-6 col-sm-12">
    ...
    <div class="box box-danger">
        ...
        <form method="get" action="{{ URL::Route('/sortpvtype') }}">
...
<div class="col-md-6 col-sm-12">
    ...
    <div class="box box-danger">
        ...
        <form method="get" action="{{ URL::Route('/searchpvtype') }}">
            <div class="box-header">
        ...
        <tbody>
            ...
            <?php foreach ($types as $type) {
                ...
                <tr>
                    ...
                    <td><?= sprintf($type->base_price, 2) ?></td>
                    <td><?= sprintf($type->price_per_unit_distance, 2) ?></td>
                    <td><?= sprintf($type->price_per_unit_time, 2) ?></td>
                    <td><?= $type->max_size ?></td>
                    <td>
                        <?php
