<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        ...
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: #ff9d3d;color: #FFFFFF;">
            <!-- logo -->            
            <div>
                <div style="float: left;"><img alt="logo" src="<?php echo $helper->asset_url(); ?><?php echo $logo; ?>" style="height: 75px;padding: 0px 0px 12px 0px;"><img alt="logo" src="{{ $helper->asset_url() }}/image/e_receipt.png" style="width: 150px;padding: 0px 0px 12px 50px;"></div>
            ...
            <div style="background-color: #FFFFFF;">
                ...
                <div style="padding: 1.5em;color: #000000;">
                    <div style="background-color: #f3f3f3;border: 2px solid #c3c3c3;border-radius: 5px;width: 45%;float: left;">
                        ...
                        <div style="margin: 15px 0px;padding: 0px;text-align: center;font-size: 14px;">
                            <div style="float: left;width: 33.32%;">
                                <p style="color: #999999;margin: 0px;padding: 0px;text-transform: uppercase;font-size: 10px;">Type name</p>
                    ...
                    <div style="width: 50%;float: right;">
                        <div>
                            ...
                            <div style="width: 40%;float: left;text-transform: uppercase;text-align: center;font-size: 12px;">Fare</div>
                            <div style="width: 30%;float: left;border-bottom: 1px solid #c3c3c3;padding-top: 8px;"></div>
                            <h1 style="clear: both;"></h1>
                        </div>
                        <div style="color: #999999;font-size: 14px;">
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Base price</p>
                            ...
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Refferal Bonus</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{  $mail_body['ref_bonus'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">Promo Bonus</p>
                ...
                <div style="margin: 0px 0px 0px 1.5em;color: #000000;">
                    <div style="margin: 15px 0px;width: 50px;border-radius: 150px; width: 90%;">
                        ...
                        <?php if ($mail_body['walker']->picture) { ?>
                        ...
                        <?php } else { ?>
                            <img style="width: 50px; height: 50px;border-radius: 150px;border: 2px solid #999999;float: left;" height="50" width="50" alt="user image" src="{{ $helper->asset_url() }}/image/default_thumb.jpg">	
                        <?php } ?>
                ...
                <div style="padding: 15px 0px 0px 0px;color: #ffffff;background-color: #ff9d3d">
                    <div style="margin: 15px 25px 15px 0;width: 50px;width: 48%;float: left; border-right: 1px solid rgba(255,255,255,.2);">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%;">
                            ...
                            <br/>
                            <span style="font-size: 12px;"><a href="{{ $helper->web_url() }}" style="color: #FFFFFF;">Contact us </a> with questions about your trip.
                                <br/>
                                Leave something behind? <a href="{{ $helper->web_url() }}" style="color: #FFFFFF;">Track it down</a></span>
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
                    ...
                    <h1 style="clear: both;"></h1>
                    <p style="text-align: center; font-size: 12px;margin-top: 30px;"> For any questions :  {{ $mail_body['contact_us_email'] }}</p>
                </div>
            </div>
        </div>
    </body>
