...
<div class="row">
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-purple">
            <div class="inner">
                <h3>
                    <?= $currency_sel ?> <?= sprintf(($credit_payment + $card_payment + $cash_payment + $promo_payment), 2) ?>
                </h3>
                <p>
                    Total Payment
                </p>
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                <h3>
                    <?= $currency_sel ?> <?= sprintf($cash_payment, 2) ?>
                </h3>
                <p>
                    Cash Payment
                </p>
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-green">
            <div class="inner">
                <h3>
                    <?= $currency_sel ?> <?= sprintf($promo_payment, 2) ?>
                </h3>
                <p>
                    Promotional Payment
                </p>
    ...
    <div class="col-lg-4 col-xs-6">
        ...
        <div class="small-box bg-red">
            <div class="inner">
                ...
                <p>
                    Total {{ trans('customize.Schedules').'s' }}
                </p>
            </div>
            <div class="icon">
                <?php /* $icon = Keywords::where('keyword', 'completed_trip')->first(); */ ?>
